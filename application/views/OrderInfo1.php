        ...
        <div id="backform" class="animate-bottom">
            <table >
                ...
                <tr id="tr1">
                    ...
                    <th style="width:200px ;">เลขออเดอร์</th>
                    <th style="width:140px ;" class="text-right">ราคา</th>
                ...
                ?>
                    <tr id="tr2" style="height: 32px;">
                        ...
                        <td id="btnTable" class="text-right">
                            ...
                            href='<?php echo base_url('index.php/controller/VerifyOR/echo '.$row->pay_id.'');?>'>ยืนยัน</a>
                            &nbsp;&nbsp;&nbsp;
                            <a id="Remove" onclick="return confirm('ยกเลิกออเดอร์');" 
                            href='<?php echo base_url('index.php/controller/DenyOR/echo '.$row->pay_id.'');?>'>ยกเลิก</a>
