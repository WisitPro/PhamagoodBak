        ...
        <div id="menu">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a  href="<?php echo base_url('/index.php/controller/ProductListPage'); ?>">รายการสินค้า</a>
                    <a  href="<?php echo base_url('/index.php/controller/ListRQ1'); ?>">ข้อมูลการนัดปรึกษา</a>
                    <a  href="<?php echo base_url('/index.php/controller/OrderInfo1'); ?>">ข้อมูลออเดอร์</a>
                </div>
            </div>
