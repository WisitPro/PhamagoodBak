        ...
        <container>
            ...
            <div id="backform" class="animate-bottom">
                <div id="cus_detail">
                    ...
                    <p>เบอร์โทร : <?php echo $row->cus_phone ?></p>
                    <p>ที่อยู่ : <?php echo $row->cus_add ?></p>
                ...
                <table>
                    ...
                    <div id="button_bar">
                        ...
                        href='<?php echo base_url('index.php/controller/DenyOR/'.$row->pay_id.'');?>'>
                            <button id="cancelbt">ยกเลิก</button></a>
                        <a onclick="return confirm('ยืนยันออเดอร์');" 
                        href='<?php echo base_url('index.php/controller/VerifyOR/'.$row->pay_id.'');?>'>
