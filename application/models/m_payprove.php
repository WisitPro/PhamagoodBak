...
class m_payprove extends CI_Model
{
    ...
    public function OrderRest()
    {
        ...
        $sql = "select p.pay_id,p.order_id,o.order_total,c.cus_name,p.pay_slip,p.pay_datetime,p.prove_status from tbl_payprove p,tbl_admin a,tbl_customer c,tbl_order o where p.order_id = o.order_id 
    ...
    public function OrderDetail($pay_id)
    {
        ...
        $sql = "select * from tbl_payprove p,tbl_admin a,tbl_customer c,tbl_order o,tbl_orderlist ol,tbl_product pd  where p.pay_id = '$pay_id' and p.order_id = o.order_id 
        and o.cus_id = c.cus_id and o.order_id = ol.order_id and ol.pro_id = pd.pro_id";
